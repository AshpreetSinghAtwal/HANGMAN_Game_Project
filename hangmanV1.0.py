...
pygame.init()
logo = pygame.image.load("/Users/aaysh/Desktop/assets/hangman6.png")
pygame.display.set_icon(logo)
music = pygame.mixer.music.load("/Users/aaysh/Desktop/assets/assets_AWM.mp3")
pygame.mixer.music.play(-1)
click = pygame.mixer.Sound("/Users/aaysh/Desktop/assets/assets_click.wav")
width = 800
height = 500
...
for i in range(7):
    image = pygame.image.load(f"/Users/aaysh/Desktop/assets/hangman{str(i)}.png")
...
class Hangman(ABC):
    ...
    def out_display(self,word):
        ...
        win_image = pygame.image.load("/Users/aaysh/Desktop/assets/winman.png")
...
def Clue():
    display.fill(background)
    clue_image=pygame.image.load("/Users/aaysh/Desktop/assets/clue.png")
    clue_check = True
    xvar=50
    yvar=425
    while clue_check:
